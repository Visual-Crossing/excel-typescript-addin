...
//                             addJob(new PrintJobService(subscriberWeatherArgs.FormulaIn, arrayData, subscriberWeatherArgs.Printer, subscriberWeatherArgs.SheetColsCount!, subscriberWeatherArgs.SheetRowsCount!, subscriberWeatherArgs.Invocation));
//                         }
//                     }
//                 }
//             }
...
//             weatherObserver.FormulaIn = formula;
...
//                     addJob(new CleanUpJobService(weatherObserver.FormulaIn, weatherObserver.ColumnsIn, weatherObserver.RowsIn, weatherObserver.Invocation));
//                 }
//                 else {
...
//                         if (arrayData && arrayData.length > 0) {
//                             addJob(new PrintJobService(weatherObserver.FormulaIn, arrayData, weatherObserver.Printer.getPrinterExcludingCaller(), weatherObserver.SheetColsCount!, weatherObserver.SheetRowsCount!,weatherObserver.Invocation));
//                         }
//                     }
